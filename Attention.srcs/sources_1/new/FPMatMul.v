...
module FPMatMul#(
  ...
  parameter ROW_1 = 8,  //token_num
  parameter COL_1 = 4,  //token_dim
  parameter ROW_2 = 4,
  parameter COL_2 = 8
)(
  ...
  output [OUTPUT_DATA_WIDTH * ROW_1 * COL_2 -1:0] out
    ...
    genvar row1_index;
    generate
      for (row1_index = 0; row1_index < ROW_1; row1_index = row1_index + 1) begin
    ...
    generate
      for (col2_index = 0; col2_index < COL_2; col2_index = col2_index + 1)begin
        for (row2_index = 0; row2_index < ROW_2; row2_index = row2_index + 1) begin
    ...
    wire [OUTPUT_DATA_WIDTH-1:0] out_mat[0:ROW_1-1][0:COL_2-1]; //8*8
