...
HD_PWD='E:/2025_vit_based_FPGA/source_code/Attention/Attention.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log Attention_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Attention_top.tcl -notrace
