...
HD_PWD='E:/2025_ViT_Based_FPGA/source_code/Attention/Attention.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Attention_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Attention_top.tcl
